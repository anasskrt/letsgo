...
func Load() Config {
	return Config{
		...
		HeatwaveTempMin:      getFloatEnv("HEATWAVE_TEMP_MIN", 25),
		HeatwaveMinDays:      getIntEnv("HEATWAVE_MIN_DAYS", 2),
		ColdwaveTempMax:      getFloatEnv("COLDWAVE_TEMP_MAX", 15),
		ColdwaveMinDays:      getIntEnv("COLDWAVE_MIN_DAYS", 2),
